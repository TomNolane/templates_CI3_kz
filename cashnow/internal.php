...
case 'soglasie': 
    ...
    $description = 'Условия получения мгновенных займов и кредитов с помощью лучшего онлайн сервиса  Cashnow с самой низкой процентной ставкой';
    break;
case 'rules': 
    $my_title = 'Основные Правила для Предоставления Срочных Займов'; 
    $description = 'Онлайн сервис  Cashnow предоставления срочных займов и кредитов с самой низкой процентной ставкой предоставляет условия для получения займов';
    break;
case 'credits': 
...
case 'money': 
    ...
    break;
case 'errors': 
    $my_title = 'Ошибки онлайн-заемщиков. Не повторять!'; 
    ...
    break;
case 'microloans': 
    $my_title = 'Микрозайм. «Страшная» правда'; 
    $description = ' Возможность получить займ в МФО существует не первый десяток лет. И до сих пор многие полагают, что стоит взять онлайн займ – и следующим шагом будет продажа квартиры. Или, как вариант, ночные звонки, угрозы и прочие «прелести».';
    break;
case 'repeat': 
...
default: $my_title = 'Срочные Займы Круглосуточно без Проверок Онлайн'; $description = 'bzaim - лучший онлайн сервис по выдаче мгновенных займов и кредитов без проверки вашей кредитной истории.Только у нас лучшие кредитные предложения!'; break;
    ...
    elseif ($this->uri->segment(1) == 'errors') { require 'internal-errors.php'; }
